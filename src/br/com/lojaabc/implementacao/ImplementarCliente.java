...
public class ImplementarCliente {
	...
	public static void main(String[] args) {
		...
		if (resposta == 'F') {
			PessoaFisica pf = new PessoaFisica("Nome da PF", "email da PF", "12345678", "123456", "123456x");
			System.out.println(pf.toString());
		} else if (resposta == 'J') {
			PessoaJuridica pj = new PessoaJuridica("Nome da PJ", "email da PJ", "12345678", "1234560001", "cnae");
